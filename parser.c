...
{
       0,    87,    87,    92,    96,   102,   103,   107,   107,   116,
     117,   120,   124,   128,   134,   137,   144,   145,   145,   148,
     148,   154,   157,   161,   162,   166,   167,   170,   171,   172,
     173,   178,   182,   183,   187,   188,   189,   190,   191,   192,
     193,   197,   198,   202,   203,   207,   211,   212,   216,   220,
     220,   221,   225,   226,   227,   228,   229,   230,   234,   236,
     238,   240,   242,   244,   246,   248,   250,   252,   254,   256,
     258,   260,   264,   265,   266,   267,   271,   272,   273,   274,
     278,   279,   283,   284,   284,   285,   285,   286,   286,   287,
     287,   292,   293,   293,   294,   298,   299,   300,   301,   302,
     303
};
#endif
...
static const char *const yytname[] =
{
  ...
  "unary_expression", "cast_expression", "postfix_expression", "$@5", "@6",
  "@7", "@8", "argument_expression_list", "$@9", "primary_expression", YY_NULLPTR
};
...
#line 170 "parser.y"
          { last_decl_type = INT_TYPE; yyval = yyvsp[0]; }
#line 1992 "parser.c"
    break;

  case 28: /* type_specifier: FLOAT  */
#line 171 "parser.y"
            { last_decl_type = FLOAT_TYPE; yyval = yyvsp[0]; }
#line 1998 "parser.c"
    break;

  case 29: /* type_specifier: CHAR  */
#line 172 "parser.y"
           { last_decl_type = CHAR_TYPE; yyval = yyvsp[0]; }
#line 2004 "parser.c"
    break;

  case 30: /* type_specifier: VOID  */
#line 173 "parser.y"
           { last_decl_type = VOID_TYPE; yyval = yyvsp[0]; }
#line 2010 "parser.c"
    break;
...
#line 2106 "parser.c"
  ...
  case 52: /* assignment_operator: ASSIGNMENT  */
#line 225 "parser.y"
                 { yyval = yyvsp[0]; }
#line 2112 "parser.c"
    break;

  case 53: /* assignment_operator: ADD_ASSIGN  */
#line 226 "parser.y"
                 { yyval = yyvsp[0]; }
#line 2118 "parser.c"
    break;

  case 54: /* assignment_operator: SUB_ASSIGN  */
#line 227 "parser.y"
                 { yyval = yyvsp[0]; }
#line 2124 "parser.c"
    break;
...
#line 2245 "parser.c"
  ...
  case 74: /* unary_operator: ADDRESS  */
#line 266 "parser.y"
              { yyval=yyvsp[0]; }
#line 2251 "parser.c"
    break;

  case 75: /* unary_operator: LOGICAL_NOT  */
#line 267 "parser.y"
                  { yyval=yyvsp[0]; }
#line 2257 "parser.c"
    break;
...
#line 2383 "parser.c"
  ...
  case 100: /* primary_expression: STRING  */
#line 303 "parser.y"
             { yyval = yyvsp[0]; }
#line 2389 "parser.c"
    break;
