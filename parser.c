...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_LESS_THAN_OR_EQUAL = 12,        /* LESS_THAN_OR_EQUAL  */
  YYSYMBOL_EQUALS = 13,                    /* EQUALS  */
  YYSYMBOL_NOT_EQUALS = 14,                /* NOT_EQUALS  */
  ...
  YYSYMBOL_OPEN_KEYS = 29,                 /* OPEN_KEYS  */
  YYSYMBOL_CLOSE_KEYS = 30,                /* CLOSE_KEYS  */
  YYSYMBOL_DOT = 31,                       /* DOT  */
  ...
  YYSYMBOL_ID = 61,                        /* ID  */
  YYSYMBOL_INT_NUMBER = 62,                /* INT_NUMBER  */
  YYSYMBOL_REAL_NUMBER = 63,               /* REAL_NUMBER  */
  YYSYMBOL_YYACCEPT = 64,                  /* $accept  */
  YYSYMBOL_initial = 65,                   /* initial  */
  YYSYMBOL_pre_program = 66,               /* pre_program  */
  YYSYMBOL_struct_declaration = 67,        /* struct_declaration  */
  YYSYMBOL_typedef_struct_declaration = 68, /* typedef_struct_declaration  */
  YYSYMBOL_program = 69,                   /* program  */
  YYSYMBOL_content = 70,                   /* content  */
  YYSYMBOL_string = 71,                    /* string  */
  YYSYMBOL_initializer = 72,               /* initializer  */
  YYSYMBOL_struct_declaration_list = 73,   /* struct_declaration_list  */
...
{
       0,    35,    35,    39,    40,    41,    42,    43,    47,    51,
      55,    59,    60,    61,    62,    63,    64,    65,    66,    67,
      68,    69,    70,    71,    75,    76,    77,    81,    82,    83,
      87,    88,    89,    90,   119,   120,   121,   122,   123,   124,
     125,   126,   127
};
#endif
...
static const char *const yytname[] =
{
  ...
  "DECREMENT", "PLUS", "MINUS", "TIMES", "OVER", "GREATER_THAN",
  ...
  "AUTO", "BREAK", "CHAR", "CONST", "CONTINUE", "DOUBLE", "ELSE", "ENUM",
  "EXTERN", "FLOAT", "WHILE", "IF", "INT", "LONG", "REGISTER", "RETURN",
  "SHORT", "SIGNED", "SIZEOF", "STATIC", "STRUCT", "TYPEDEF", "UNION",
  "UNSIGNED", "VOID", "VOLATILE", "STRING", "ID", "INT_NUMBER",
  "REAL_NUMBER", "$accept", "initial", "pre_program", "struct_declaration",
  "typedef_struct_declaration", "program", "content", "string",
  "initializer", "struct_declaration_list", "type_specifier", YY_NULLPTR
};
...
{
       0,   -57,   -46,    11,   -24,     0,     0,    24,   -43,   -58,
       2,   -58,   -58,   -58,   -11,    31,    39,   -58,   -58,   -58,
     -58,   -58,   -58,   -58,   -58,   -58,    35,     5,   -11,    41,
      36,    -6,    37,    40,    42,   -58,   -28,   -11,   -11,    12,
     -34,   -58,    44,    46,   -58,   -58,    43,    15,   -30,    48,
      18,   -58,   -58,   -58,    49,    19,    50,   -58,   -13,    51,
     -58,   -17,    56,   -34,    -1,   -34,   -34,    -1,    -1,   -58,
     -58,   -58,   -58,    52,   -58,   -58,    53,    54,   -34,   -34,
     -34,   -58,   -58,   -58
};
...
{
       7,     0,     0,     0,     0,     3,     5,     0,     0,     1,
       0,     2,     4,     6,     0,     0,     0,    35,    40,    39,
      37,    38,    36,    41,    42,    34,     0,     0,     0,     0,
       0,     0,     0,     0,     0,     8,     0,    30,    32,     0,
       0,    25,     0,     0,    31,    33,     0,     0,     0,     0,
       0,    26,    24,     9,     0,     0,     0,    10,     0,     0,
      23,     0,     0,    11,     0,    13,    15,     0,     0,    12,
      29,    27,    28,     0,    14,    16,     0,     0,    17,    19,
      21,    18,    20,    22
};
...
{
      41,    55,    17,    67,     7,    18,    27,    64,     8,    19,
      36,     9,    20,    21,    36,    47,    22,    23,    15,    65,
      27,    36,    10,    24,    25,    17,    37,    48,    18,    27,
      27,    56,    19,    42,    43,    20,    21,    12,    13,    22,
      23,    69,    33,    74,    75,    59,    24,    25,    76,    77,
      62,    44,    45,    14,     1,     2,    81,    82,    83,    70,
      28,    71,    72,    16,    29,    30,    31,    34,    35,    38,
      39,    40,    51,    46,    52,    53,    68,    54,    57,    58,
      61,    60,    63,    66,    78,    79,    80
};

static const yytype_int8 yycheck[] =
{
      28,    31,    36,    20,    61,    39,    14,    20,    54,    43,
      27,     0,    46,    47,    27,    49,    50,    51,    61,    32,
      28,    27,    46,    57,    58,    36,    32,    61,    39,    37,
      38,    61,    43,    61,    62,    46,    47,     5,     6,    50,
      51,    63,    28,    65,    66,    50,    57,    58,    67,    68,
      55,    37,    38,    29,    54,    55,    78,    79,    80,    60,
      29,    62,    63,    61,    25,    30,    61,    26,    32,    32,
      30,    29,    28,    61,    28,    32,    20,    62,    30,    61,
      61,    32,    32,    32,    32,    32,    32
};
...
{
       0,    54,    55,    65,    66,    67,    68,    61,    54,     0,
      46,    69,    66,    66,    29,    61,    61,    36,    39,    43,
      46,    47,    50,    51,    57,    58,    73,    74,    29,    25,
      30,    61,    71,    73,    26,    32,    27,    32,    32,    30,
      29,    28,    61,    62,    73,    73,    61,    49,    61,    70,
      74,    28,    28,    32,    62,    31,    61,    30,    61,    71,
      32,    61,    71,    32,    20,    32,    32,    20,    20,    70,
      60,    62,    63,    72,    70,    70,    72,    72,    32,    32,
      32,    70,    70,    70
};
